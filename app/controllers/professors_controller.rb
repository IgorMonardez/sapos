...
class ProfessorsController < ApplicationController
  ...
  active_scaffold :professor do |config|
    ...
    config.columns[:institutions].form_ui = :record_select
    config.columns[:affiliations].form_ui = :record_select
    ...
    form_columns = [
      ...
      :siape, :institutions, :scholarships, :academic_title_level,
